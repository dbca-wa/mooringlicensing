        ...
        with transaction.atomic():
            ...
            if sale_date:
                ...
                for approval in approval_list:
                    ...
                    stickers_updated = []
                    for a_sticker in approval.stickers.filter(status__in=[Sticker.STICKER_STATUS_CURRENT, Sticker.STICKER_STATUS_AWAITING_PRINTING]).filter(vessel_onwership__vessel__rego_no=rego_no):
                    ...
                    for a_sticker in approval.stickers.filter(status__in=[Sticker.STICKER_STATUS_READY, Sticker.STICKER_STATUS_NOT_READY_YET]).filter(vessel_onwership__vessel__rego_no=rego_no):
