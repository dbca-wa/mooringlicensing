...
from mooringlicensing.components.proposals.models import (
    ...
    MooringUserAction, AnnualAdmissionApplication
)
from mooringlicensing.components.main.models import GlobalSettings, ApplicationType
...
class InternalProposalSerializer(BaseProposalSerializer):
    ...
    affected_by_fee_constructor_change = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = (
                ...
                'affected_by_fee_constructor_change'
                )
        read_only_fields = (
            'documents',
            'requirements',
...
class ListMooringSerializer(serializers.ModelSerializer):
    ...
    def get_holder(self, obj):
        if obj.mooring_licence and obj.mooring_licence.approval and not obj.mooring_licence.approval.status in ["surrendered","cancelled","expired"]:
            try:
